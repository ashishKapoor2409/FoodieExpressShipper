package com.example.android.foodieexpressshipper.Adapter
...
import com.example.android.foodieexpressshipper.ShippingActivity
...
var shippingOrderModelList: List<ShipperOrderModel>) : RecyclerView.Adapter<MyShippingOrderAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        Glide.with(context)
            .load(shippingOrderModelList.get(position)
